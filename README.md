...
* CareerSwipe – A swipe-based job recommendation system
* Weather App
* Web Development Projects

### 🎯 Goals

* Become a skilled UI/UX Designer
* Build products that solve real-world problems
* Contribute to open-source projects
* Continuously improve my technical and design skills


⭐ "Design is not just how it looks; it's how it works."

<!--
**Karxtha/Karxtha** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
